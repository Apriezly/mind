    ...
    <div class="sidebar">
      <nav class="pt-5">
        <ul class="nav nav-pills nav-sidebar flex-column" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="https://wa.me/628977924013?text=Hai,%20Admin!%20Saya%20perlu%20penjelasan%20dan%20cara%20penggunaan%20Aplikasi%20Mind,%20bisa%20tolong%20dibantu?%20" class="nav-link {{ Request::segment(1) == 'bantuan' ? 'active-link' : 'nonactive-link'}}">
