    ...
    <div class="container">
        <div class="container-fluid mb-5">
            <div class="row">
                <div class="col-12">
                  <div>
                    <p class="mb-4 judul-utama">Pengingat</p>
                  </div>
                        ...
                        <div class="col-12">
                            ...
                            <a class="row align-items-center mb-4" href="{{ url('/lihatnotifikasi')}}">
                                <div class="col-1 text-center">
                                    ...
                                    <span class="belum-dibaca" style="font-size:10px !important; color:#404040 !important;">12 Nov</span>
                                </div>
                                <div class="col ml-2">
                            ...
                            <a class="row align-items-center mb-4">
                                <div class="col-1 text-center">
                                    <img src="{{ asset('/element/user-mind.svg')}}" alt="">
                                    <span class="sudah-dibaca" style="font-size:10px !important; color:#404040 !important;">12 Nov</span>
                                </div>
                                <div class="col ml-2">
